...
## 版本說明
### Prototype版（最新版本：[prototype-v0.1.0](https://github.com/RainbowUnicorn7297/mltd-relive/releases/tag/prototype-v0.1.0)）
...
- 未解鎖的覺醒故事不能透過進行覺醒來解鎖。
- 活動劇情暫不支援以下MILLION LIVE WORKING☆活動對話：
  - ～恐怖！偶像心驚肉跳試膽大會&偶像試膽醫院～
  - ～玩味秋天！百萬秋季博覽會～
