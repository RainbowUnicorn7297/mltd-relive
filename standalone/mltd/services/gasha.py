        ...
        A dict containing the following keys.
            gasha_list: A list of dicts representing available gacha
                ...
                currency_type_list: A list of integers representing the
                                    ...
                                    2 = Gacha medals
                                    6 = Free jewels
                is_paid_jewel_only: Whether the gacha is paid jewel
                                    only.
                draw1_jewel_value: Number of jewels required to cast a
                                   single draw.
                draw10_jewel_value: Number of jewels required to cast 10
                                    draws.
                draw1_mst_item_id: The master item ID of the item
                                   required to cast a single draw (0 if
                                   none).
                draw10_mst_item_id: The master item ID of the item
                                    required to cast 10 draws (0 if
                                    none).
                ...
                sr_passport: If an SR card is guaranteed for casting 10
                             draws, this value is 1. Otherwise, this
                             value is 0.
                ssr_passport: 0.
                ...
                ticket_item_list: A list of dicts representing the
                                  required items to cast draws for this
                                  gacha (empty if none). See the return
                                  value 'item_list' of the method
                                  'ItemService.GetItemList' for the dict
                                  definition.
                is_limit: Unknown.
                          Possible meaning #1: Whether the draw point
                            max limit is applied to this gacha banner.
                          Possible meaning #2: Whether this is a
                            limited-time gacha banner.
                draw_point_mst_item_id: Master item ID representing draw
                                        points (40).
                draw_point: Number of draw points the user currently
                            has.
                draw_point_max: Maximum number of draw points a user can
                                have before they are required to use
                                them in exchange for a card (300).
