    ...
    Returns:
        ...
        game_setting: A dict representing various game settings.
            ...
            awakening_config_list: A list of dicts representing the
                                   required items for awakening. Each
                                   dict contains the following keys.
                rarity: Card rarity (1-4).
                idol_type: Card idol type (1-3, 5).
                mst_card_id: To which card does this config applies (0
                             if this config applies to all cards of the
                             specified rarity and idol type).
                required_item_list: A list of dicts containing the
                                    following keys.
                    mst_item_id: Master item ID.
                    amount: Number of items needed.
            master_lesson2_config_list: A list of dicts representing the
                                        required master pieces for
                                        master rank lessons. Each dict
                                        contains the following keys.
                rarity: Card rarity (1-4).
            ...
            ex_master_lesson_config_list: A list of dicts representing
                                          the required number of PST/FES
                                          pieces for master rank
                                          lessons. Each dict contains
                                          the following keys.
                ex_type: Card extra type [2=PST (Ranking), 3=PST (Event
                         Pt), 4=FES, 5=1st, 6=Ex].
                mst_item_id: Master item ID of the PST piece/FES master
                             piece.
                amount: A list of 4 ints representing the required
                        number of PST/FES pieces for master ranks 1-4.
                mst_card_id: To which card does this config applies (0
                             if this config applies to all cards of the
                             specified ex_type).
            lesson_money_config_list: A list of dicts representing the
                                      money required per ticket for
                                      lessons. Each dict contains the
                                      following keys.
            ...
            lesson_skill_level_up_config_list: A list of dicts
                                               ...
                                               'skill EXP' for each
                                               skill level for
                                               guaranteed level up. Each
                                               dict contains the
                                               following keys.
                skill_level: Target skill level (1-12).
                rarity: Card rarity (1-4).
                value: Required 'skill EXP' for guaranteed level up to
                       the target skill level. 'Skill EXP' provided per
                       ticket is defined as follows:
                            Lesson ticket N=0
                            Lesson ticket R=300
                            Lesson ticket SR=1000
                            Lesson ticket SSR=2000
            rank5_skill_level_max: Maximum possible skill level for a
                                   master rank 5 card (12).
            lesson_wear_config_list: A list of dicts representing the
                                     available lesson wears. Each dict
                                     contains the following keys.
                mst_lesson_wear_setting_id: Master lesson wear setting
                                            ID (1, 9001).
                mst_lesson_wear_group_id_list: A list containing a
                                               single int representing
                                               the lesson wear group ID
                                               (1, 9001).
            awakening_bonus_level: Number of additional levels a card
                                   can be trained after awakening (10).
            max_master_rank: Maximum possible master rank for a non-
                             master rank 5 card (4).
            master_rank_bonus: Bonus % increase in vocal/dance/visual
                               values per master rank (3).
            card_lv_base: Increase in required card EXP per level (20).
            card_lv_diff: Required card EXP to level up a level 1 card
                          to level 2 (10).
            user_lv_base: Increase in required user EXP per level (100).
            user_lv_diff: Required user EXP to level up from level 1 to
                          level 2 (50).
            recover_jewel: A dict representing the required jewels to
                           recover 100% vitality. Contains the following
                           keys.
                amount: Number of jewels required.
                begin_date: '2018-01-01T00:00:00+0800'.
                end_date: '2099-12-31T23:59:59+0800'.
            continue_jewel: A dict representing the required jewels to
                            continue a song when life reaches 0. See
                            'recover_jewel' for the dict definition.
            ...
            enable_sales_costume: Whether costume shop is enabled
                                  (true).
            enable_gasha_exchange_limit_point: Whether gacha exchange
                                               limit point is enabled
                                               (true).
            enable_event_shop: Whether event shop is enabled (true).
            enable_unit: Whether user-defined units are enabled (true).
            ...
            enable_song_unit_duo: Whether duo song units are enabled
                                  (true).
            enable_song_full_random: Whether full random is enabled in
                                     song select (true).
            enable_song_song_random: Whether song random is enabled in
                                     song select (true).
            enable_a1st_card_shop: Whether 1st anniversary card shop is
                                   enabled (false).
            enable_training: Whether 2nd anniversary training is enabled
                             (true).
            lounge_chat_fetch_cycle: A list of ints representing how
                                     often the lounge chat is fetched.
            ...
            comic_menu_list: A list of dicts representing available
                             comic menu items. Each dict contains the
                             following keys.
            ...
            training_unit_list: A list of dicts representing the
                                ...
                                anniversary training missions. Each dict
                                contains the following keys.
                mst_song_unit_id: Master song unit ID.
                idol_id_list: A list of 54 master idol IDs representing
                              the song unit idols for this mission. If
                              the song unit has less than 54 idols,
                              zeros are appended to this list.
            master_lesson_five_config_list: A list of dicts representing
                                            the required items for
                                            master rank 5 lessons. Each
                ...
                required_item_list: A list of dicts containing the
                    ...
                    mst_item_id: Master item ID.
                    amount: Number of items needed.
            un_lock_song_jewel: A dict representing the required jewels
                                to unlock a song in the shop. See
                                'recover_jewel' for the dict definition.
            mst_item_id_with_type_master_key: Master item ID of singing
                                              voice master key (51).
            title_image_list: A list of dicts representing available
                              title screen images. Each dict contains
                              the following keys.
                mst_title_image_id: Master title image ID.
                title_image_type: Title image type (2=event, 3=others).
                sort_id: Sort ID.
            ...
            enable_flower_stand_multi: Whether multiple flower stands
                                       can be gifted to friends at the
                                       same time (true).
            enable_n_t4: Unknown (false).
            function_release_id_list: Unknown (a list of ints).
            default_release_all_song_difficulty_lv: At which user level
                                                    all main story songs
                                                    are unlocked (50).
        ...
        loading_character_list: A list of dicts representing loading
                                ...
                                following keys.
            resource_id: A string for getting resources related to this
                         loading screen character.
            weight: 1.
            begin_date: Date when this loading screen character becomes
                        available.
            end_date: Date when this loading screen character becomes
                      unavailable.
    """
